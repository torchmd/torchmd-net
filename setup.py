...
# Fix for building Windows CUDA packages. They cannot find the CUDA libraries during compilation.
cuda_lib_dir = os.environ.get("CUDA_HOME", "")
if not cuda_lib_dir:
    cuda_lib_dir = os.environ.get("CUDA_PATH", "")
extra_args = {}
if cuda_lib_dir and is_windows:
    extra_args["library_dirs"] = [os.path.join(cuda_lib_dir, "lib/x64")]
