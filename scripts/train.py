...
def get_args():
    ...
    parser.add_argument('--train-size', type=float, default=None, help='Percentage/number of samples in training set')
    parser.add_argument('--val-size', type=float, default=0.05, help='Percentage/number of samples in validation set')
    parser.add_argument('--test-size', type=float, default=0.1, help='Percentage/number of samples in test set')
