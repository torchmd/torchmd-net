...
# Uses a 2D grid launch so that the flat thread index can exceed 2^31.
# The triangular formula and t_i comparisons use int64 arithmetic.
# This is slower than the int32 kernel due to int64 throughput limits on
# consumer GPUs, but correctness requires it at this scale.
# ---------------------------------------------------------------------------
