...
def get_argparse():
    ...
    parser.add_argument('--freeze_representation', type=bool, default=False, help='Freeze the representation model parameters during training. This option is only used if the training is not starting from scratch.')
